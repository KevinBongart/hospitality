...
class SecretariesControllerTest < ActionController::TestCase
  ...
  test "should create secretary" do
    assert_difference('Secretary.count') do
      post :create, secretary: { doctor_id: @secretary.doctor_id, hospital_id: @secretary.hospital_id, name: @secretary.name }
    end
  ...
  test "should update secretary" do
    put :update, id: @secretary, secretary: { doctor_id: @secretary.doctor_id, hospital_id: @secretary.hospital_id, name: @secretary.name }
    assert_redirected_to secretary_path(assigns(:secretary))
  end
